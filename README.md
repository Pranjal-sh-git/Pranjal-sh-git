...
<br />
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=26&duration=3000&pause=800&color=00F5FF&center=true&vCenter=true&width=750&lines=Welcome+to+my+GitHub+Profile!;I+train+models+that+think.;I+craft+videos+that+wow.;Always+learning%2C+always+building." alt="Typing SVG" />
<br /><br />
...
|
 🤖 AI & Machine Learning 
|
 Training models, working with data pipelines 
|
|
 💻 Backend Engineering 
|
 Building REST APIs, databases & cloud systems 
|
|
 📊 Data & Analytics 
|
 SQL, MongoDB, Power BI dashboards 
|
|
 🎬 Video Crafting 
|
 Color grading, editing, visual enhancement 
|
|
 ☁️ Cloud 
|
 Microsoft Azure deployments & services 
|
---
<!-- ═══════════════════════════════════════════════════════════ -->
<!--                    TECH STACK & SKILLS                    -->
...
|
 🎨 Visual Enhancement 
|
 Color grading, lighting correction & audio polish 
|
|
 🎞️ Engaging Storytelling 
|
 Dynamic cuts, pacing & visual transitions 
|
|
 📱 Content Optimization 
|
 Tailoring structure for platform-specific audiences 
|
---
<!-- ═══════════════════════════════════════════════════════════ -->
<!--                     GITHUB STATS                          -->
